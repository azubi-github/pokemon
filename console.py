...
from interface import battle_scene
...
for line in random_pokemon:
    random_choice = Pokemon(name=POKEMON_DATA[line]['name'],
                            ...
                            health=POKEMON_DATA[line]['health'],
                            defense=POKEMON_DATA[line]['defense'],
                            speed=POKEMON_DATA[line]['speed'],
                            attack=POKEMON_DATA[line]['attack'])
    enemy_team.add_pokemon(random_choice)
    enemy_team_names.append(POKEMON_DATA[line]['name'])

choose_fight = input('Do you want an Interface? (y/n) ').lower().strip()
