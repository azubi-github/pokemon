...
ELEMENT_TYPE = {
    ...
    'Grass': {'Fire': 0.5, 'Grass': 1, 'Water': 2, 'Normal': 1}
}

POKEMON_ATTACK_VALUES = {
'tackle': {'Attack_Strength': 30, 'Accuracy': 100, 'element': 'normal'}, 'MEME-BEAM': {'Attack_Strength': 4000000, 'Accuracy': 100, 'element': 'Normal'},
'Water_Gun': {'Attack_Strength': 40, 'Accuracy': 100, 'element': 'Water'}, 'Wet-Fart': {'Attack_Strength': 60, 'Accuracy': 80, 'element': 'Water'}, 'Nasses-Handtuch': {'Attack_Strength': 80, 'Accuracy': 60, 'element': 'Water'},
'Ember': {'Attack_Strength': 40, 'Accuracy': 100, 'element': 'Fire'}, 'Deo+Feuerzeug': {'Attack_Strength': 60, 'Accuracy': 80, 'element': 'Fire'}, 'Indisches_Chili': {'Attack_Strength': 80, 'Accuracy': 60, 'element': 'Fire'},
'Vine_Whip': {'Attack_Strength': 40, 'Accuracy': 100, 'element': 'Grass'}, 'Brenneseln': {'Attack_Strength': 60, 'Accuracy': 80, 'element': 'Grass'}, 'Kastanien_Attentat': {'Attack_Strength': 80, 'Accuracy': 60, 'element': 'Grass'}
}
